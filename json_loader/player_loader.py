...
def insert_data_in_player_table(connection, player_data, team_id, match_id):
    ...
    for position in player_data.get('positions', {}):
        position_data = (position.get('position_id'), position.get('position'), position.get('from'), position.get('to'), position.get('from_period'), position.get('to_period'), position.get('start_reason'), position.get('end_reason'), team_id, match_id, player_data.get('player_id'))
